...
from Model.GeneralObject import GeneralObject
import math
...
class Bspline(GeneralObject):
    ...
    def __coxDeBoor(self, degree, controlPoints, knots, u, i, p):
        ...
        if p == 0:
            ...
            return self.__coxDeBoor(degree, controlPoints, knots, u, i - 1, p - 1) * (1 - alpha) + self.__coxDeBoor(
                degree, controlPoints, knots, u, i, p - 1) * alpha
